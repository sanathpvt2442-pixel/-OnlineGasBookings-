...
const Profile = () => {
    ...
    useEffect(() => {
        axios
            .post(
                ...
                "http://localhost:4000/api/getUserSpendingByCompany",
                { username: user }
            )
            .then((res) => {
        ...
        axios
            .post("http://localhost:4000/api/getTotalSpendings", {
                username: user,
            })
            .then((res) => {
        ...
        axios
            .post("http://localhost:4000/api/getTotalOrders", {
                username: user,
            })
            .then((res) => {
        ...
        axios
            .post("http://localhost:4000/api/getProfile", {
                username: user,
            })
            .then((res) => {
        ...
        axios
            .post("http://localhost:4000/api/getPendingOrders", {
                username: user,
            })
            .then((res) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios
            .post("http://localhost:4000/api/updateProfile", {
