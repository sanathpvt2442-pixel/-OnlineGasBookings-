...
class GasBookingDatabase {
    ...
    register(
        ...
        this.pool.query(
            `INSERT INTO customer (firstname,lastname,username,password,pincode,email,address,phone_number,adhar) VALUES ('${firstname}','${lastname}','${username}','${password}',${pincode},'${email}','${address}',${phone_number},${adhar})`,
            (err, result) => {
                if (err) {
